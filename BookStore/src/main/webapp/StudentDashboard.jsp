    ...
    <div class="container">
        ...
        <div class="dashboard-grid">
            ...
            <div class="card">
                <h3>🚀 Quick Actions</h3>
                <ul>
                    <li><a href="SearchBook.html"><span class="icon">🔍</span>Search for Books</a></li>
                    <li><a href="show-order.jsp"><span class="icon">🛒</span>View Shopping Cart</a></li>
                    <li><a href="PurchaseHistory. jsp"><span class="icon">📋</span>View Purchase History</a></li>
                    <li><a href="AllBooks.jsp"><span class="icon">📚</span>Browse All Books</a></li>
                </ul>
            </div>
